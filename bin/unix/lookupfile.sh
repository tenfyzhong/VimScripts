...
find $project -not -regex '.*\.\(png\|gif\|mp3\|mp4\|pdf\|o\|d\|a\|so\|class\|obj\|exe\|jar\|zip\|out\|lookupfile_tags\|tags\|bak\|pyc\|swp\|doc\|docx\|xls\|xlsx\|ppt\|pptx\|tgz\|tar.gz\|d\.\d\d*\|Plo\|Po\)' \
